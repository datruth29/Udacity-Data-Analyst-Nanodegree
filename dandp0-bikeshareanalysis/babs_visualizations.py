...
def usage_stats(data, filters=False, verbose=True):
    """
...
def usage_plot(data, key='', filters=False, size=(8, 6), show_usage_stats=False, **kwargs):
    ...
    if data[key].dtype.name == 'category' or data[key].dtype.name == 'object':  # Categorical features
